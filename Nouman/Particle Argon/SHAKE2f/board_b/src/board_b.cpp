...
#define PUBKEY_HEX_MAXLEN (PQCLEAN_SPHINCSSHAKE128FSIMPLE_CLEAN_CRYPTO_PUBLICKEYBYTES * 2 + 1)
...
#define SIG_HEX_MAXLEN (PQCLEAN_SPHINCSSHAKE128FSIMPLE_CLEAN_CRYPTO_BYTES * 2 + 1)
...
uint8_t receivedPubKeyBytes[PQCLEAN_SPHINCSSHAKE128FSIMPLE_CLEAN_CRYPTO_PUBLICKEYBYTES];
uint8_t receivedSigBytes[PQCLEAN_SPHINCSSHAKE128FSIMPLE_CLEAN_CRYPTO_BYTES];
