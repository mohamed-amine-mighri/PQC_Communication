...
#define PUBKEY_HEX_MAXLEN (PQCLEAN_SPHINCSSHA2128SSIMPLE_CLEAN_CRYPTO_PUBLICKEYBYTES * 2 + 1)
...
#define SIG_HEX_MAXLEN (PQCLEAN_SPHINCSSHA2128SSIMPLE_CLEAN_CRYPTO_BYTES * 2 + 1)
...
uint8_t receivedPubKeyBytes[PQCLEAN_SPHINCSSHA2128SSIMPLE_CLEAN_CRYPTO_PUBLICKEYBYTES];
uint8_t receivedSigBytes[PQCLEAN_SPHINCSSHA2128SSIMPLE_CLEAN_CRYPTO_BYTES];
...
void verifySignature() {
    ...
    int ret = PQCLEAN_SPHINCSSHA2128SSIMPLE_CLEAN_crypto_sign_verify(
        receivedSigBytes,
        PQCLEAN_SPHINCSSHA2128SSIMPLE_CLEAN_CRYPTO_BYTES,
