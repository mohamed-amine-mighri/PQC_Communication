...
def extract_last_valid_json(json_lines):
...
def main():
    ...
    try:
        ...
        last_json = extract_last_valid_json(json_lines)
        ...
        result = {
            ...
            "pk_len": last_json.get("pk_len"),
            "sk_len": last_json.get("sk_len"),
            "sig_len": last_json.get("sig_len"),
            "msg_len": last_json.get("msg_len"),
            "last_ok": last_json.get("ok"),
