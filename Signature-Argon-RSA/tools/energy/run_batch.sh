...
SCRIPT="$HOME/pqc/PQC_Communication/Signature-Argon-RSA/tools/energy/run_ppk2_bench_argon.py"
OUT="$HOME/pqc/PQC_Communication/Signature-Argon-RSA/results/energy/argon_energy.jsonl"

ARGON_PORT="/dev/ttyACM0"
FIRMWARE_BIN="$(ls -t "$HOME/pqc/PQC_Communication/Signature-Argon-RSA"/argon_firmware_*.bin | head -n 1)"
